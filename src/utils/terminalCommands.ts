...
const COMMANDS: Record<string, CommandDef> = {
  ...
  whoami: {
    ...
    run: () => ({ lines: [
      ...
      line(''),
      line('stack'),
      line('  shipped:  php, javascript, react, sql, html/css', 'dim'),
      line('  side:     typescript, python, fastapi, postgres, redis, deck.gl', 'dim'),
      line(''),
      line(''),
      line('contact'),
      line("  github    <a style='color:var(--accent)' target='_blank' href='https://github.com/wiktorspryszynski'>github.com/wiktorspryszynski</a>", 'dim', true),
      line("  linkedin  <a style='color:var(--accent)' target='_blank' href='https://www.linkedin.com/in/wiktor-spryszynski/'>linkedin.com/in/wiktor-spryszynski</a>", 'dim', true),
      line("  email     <a style='color:var(--accent)' href='mailto:spryszynskiwiktor@gmail.com'>spryszynskiwiktor@gmail.com</a>", 'dim', true),
      line("  cv        <a style='color:var(--accent)' href='/_CV_Wiktor_Spryszynski_ENG.pdf' download>_CV_Wiktor_Spryszynski_ENG.pdf</a>", 'dim', true),
    ]}),
  },
  ...
  ls: {
    help: 'list projects',
    run: () => ({ lines: [
      line("  <span style='color:var(--ok)'>nom-nom/</span>               diet companion PWA              <a style='color:var(--accent)' target='_blank' href='https://github.com/wiktorspryszynski/nom-nom'>LINK</a> ", 'out', true),
      line("  <span style='color:var(--ok)'>flight-scope/</span>          live flight tracker             <a style='color:var(--accent)' target='_blank' href='https://github.com/wiktorspryszynski/flight-scope'>LINK</a> ", 'out', true),
      line("  <span style='color:var(--ok)'>spotify-recommender/</span>   playlist generator · archived   <a style='color:var(--accent)' target='_blank' href='https://github.com/wiktorspryszynski/spotify-recommender'>LINK</a> ", 'out', true),
      line("  <span style='color:var(--ok)'>wiktorspryszynski/</span>     readme bot                      <a style='color:var(--accent)' target='_blank' href='https://github.com/wiktorspryszynski/wiktorspryszynski'>LINK</a> ", 'out', true),
    ]}),
  },
