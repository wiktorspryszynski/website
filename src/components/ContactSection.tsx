  ...
  return (
    <section id="contact" className="contact">
      ...
      <ul className="contact-list">
        <li>
          <button
            className={`contact-line${copied ? ' copied' : ''}`}
          ...
          >
            ...
            <span className="contact-cta">{t(lang, 'copy', 'skopiuj')}</span>
          </button>
          <a className="contact-side" href={`mailto:${EMAIL}`} aria-label="Open in mail app" title="open in mail app">↗</a>
        </li>
        <li>
          <a className="contact-line" href="https://github.com/wiktorspryszynski" target="_blank" rel="noopener">
            <span className="icn" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="contact-val">github.com/wiktorspryszynski</span>
            <span className="contact-cta">↗</span>
          </a>
        </li>
        <li>
          <a className="contact-line" href="https://www.linkedin.com/in/wiktor-spryszynski/" target="_blank" rel="noopener">
            <span className="icn" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="contact-val">in/wiktor-spryszynski</span>
            <span className="contact-cta">↗</span>
          </a>
        </li>
        <li>
          <a className="contact-line" href={resumeHref} download>
            <span className="icn" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="contact-key">{t(lang, 'résumé', 'cv')}</span>
            <span className="contact-val">{t(lang, 'PDF, one page', 'PDF, jedna strona')}</span>
            <span className="contact-cta">↓</span>
          </a>
        </li>
      </ul>
